  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'h-9 w-9 p-0 text-center text-sm [&:has([aria-selected])]:rounded-md [&:has([aria-selected])]:bg-accent/50',
        day_button:
        ...
        nav: 'absolute top-0 inset-x-0 flex h-7 items-center justify-between z-10',
        outside: 'text-muted opacity-50 aria-selected:bg-accent/40',
        selected:
          'rounded-md bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
        today: 'rounded-md bg-secondary text-secondary-foreground',
