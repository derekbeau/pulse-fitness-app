...
export function StatCard({ value, label, trend, icon, className, ...props }: StatCardProps) {
      ...
      <CardContent className="space-y-2">
        ...
        {trend && trendStyle && TrendIcon ? (
          <div
            ...
            className={cn('flex items-center gap-2 text-sm font-medium', trendStyle.className)}
          >
