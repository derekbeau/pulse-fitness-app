...
export function SessionHeader({
  ...
  return (
    <Card
      className={cn('overflow-hidden border-transparent py-0 shadow-lg backdrop-blur-sm', className)}
      style={{ backgroundColor: 'var(--color-accent-cream)' }}
    >
      <CardContent className="space-y-5 px-5 py-5 text-[var(--color-on-accent)] sm:px-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-[var(--color-on-accent)]/75">
          ...
          <div className="grid grid-cols-2 gap-3 sm:min-w-80">
            ...
            />
            <SessionStat icon={ListChecks} label="Sets done" value={`${completedSets}/${totalSets}`} />
            <div className="rounded-2xl border border-[var(--color-on-accent)]/15 bg-white/45 p-3">
              <p className="text-[11px] font-semibold tracking-[0.18em] text-[var(--color-on-accent)]/65 uppercase">
                Progress
              </p>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-3 text-sm">
            <span className="font-medium text-[var(--color-on-accent)]/70">Set progress</span>
