...
const GoalTrajectoryPage = lazy(async () => {
  const module = await import('./pages/goal-trajectory');
  return { default: module.GoalTrajectoryPage };
});
...
const ProgressPhotosPage = lazy(async () => {
  const module = await import('./pages/progress-photos');
  return { default: module.ProgressPhotosPage };
});
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route element={renderWithPageFallback(<CalendarPage />)} path="calendar" />
        ...
        />
        <Route
          element={renderWithPageFallback(<GoalTrajectoryPage />)}
          path="nutrition/goals/:goalId"
        />
        ...
        <Route element={renderWithPageFallback(<ProgressPhotosPage />)} path="body/photos" />
        <Route
