...
const statusBefore = git('status', '--short', '--untracked-files=no');
...
const cacheControls = Object.fromEntries(
  ['TURBO_FORCE', 'TURBO_CONCURRENCY', 'TURBO_ENV_MODE', 'CI']
...
const header = [
  'RECEIPT_FORMAT: pulse-132-raw-v1',
...
const receipt = {
  receiptFormat: 'pulse-132-json-v1',
  testedCommit: commit,
  testedTree: tree,
  branch,
  worktree,
