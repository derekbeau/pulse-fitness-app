> Historical executor receipt for f915499, rejected by independent review. Its numeric-ranking and concurrency conclusions are superseded by `../issue-138-repair/README.md`. Raw logs remain unchanged.
...
| -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ranked, explainable, advisory candidates           | `foods/reuse-policy.ts` and literal v1 policy tests cover exact/punctuation/possessive, alias, brand/tag, token order, recent names, weak partial matches, ties, and explicit ambiguity before limits. Independent review rejected the numeric ranked score. The repair removes it entirely from public ranked matches; see the superseding repair receipt. |
